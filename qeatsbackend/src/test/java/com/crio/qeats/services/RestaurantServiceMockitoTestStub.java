...
public class RestaurantServiceMockitoTestStub {
  ...
  public void  testFindNearbyWithin3km() throws IOException {
    ...
    List<Restaurant> restaurantList1 = Arrays.asList(restaurant1,restaurant2,restaurant3);
    ...
    assertEquals(3, allRestaurantsCloseByOffPeakHours.getRestaurants().size());
    ...
    assertEquals("13", allRestaurantsCloseByOffPeakHours.getRestaurants().get(2).getRestaurantId());
