...
public class RestaurantController {
  ...
  public ResponseEntity<GetRestaurantsResponse> getRestaurants(@RequestParam Double latitude, @RequestParam Double longitude, @RequestParam(required = false) String searchFor) {
    ...
    if(!isGetRestaurantsRequestValid(getRestaurantsRequest)){
  ...
  private boolean isGetRestaurantsRequestValid(GetRestaurantsRequest getRestaurantsRequest){
